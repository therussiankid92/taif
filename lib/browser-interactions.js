...
class BrowserInteractions {
 ...
 /** We get the requested technology and initalize the driver to load the proper browser implementation class of that automation technology **/
  ...
  /** The implementation of this class in a certain automation technology initalized as the driver is called inside the method **/
    ...
    {
        return this.driver.findElement(elementsIdentifier)
    }
    ...
    checkApiResponseStatusCode (requestOrderNumber,timeToWaitForRequest, method,url,code){
        this.driver.checkApiResponseStatusCode(requestOrderNumber, timeToWaitForRequest, method,url,code)
    }
    checkApiResponseStatusCodeSmart(method, url, code) {
        this.driver.checkApiResponseStatusCodeSmart(method,url,code)
    }
