...
class WdioBrowserImplementation {
    ...
    elementVisible(element){
        console.log("Method not implemented in Wdio. Please contribute.")
    }
    ...
    waitForElementNotExists(element){
        element.isExisting(undefined, true)
    }
    ...
    uploadFileWhenUploadInputNotDisplayed(inputClass, filePath){
        let input = this.findElement(inputClass);

        browser.execute(
          // assign style to elem in the browser
          (el) => el.style.cssText = 'display:block !important',
